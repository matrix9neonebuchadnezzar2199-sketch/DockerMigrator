> **アーカイブ済み (2026-05-19)**: 本指示書の作業は 2026-05-18 に完了済み。
> 完了コミット: `762f15b` 以降の Step 6 関連コミット群、および `3c120f2`（指示書自体の push）。
> 関連記録: `CHANGELOG.md` v0.2.0-poc、`docs/dmig-manifest-1.1.md`（正本 v1.0）、開発日記 2026-05-18 `#entry-1505` 付近。
> 再実行用ではなく履歴参照用として保管。
